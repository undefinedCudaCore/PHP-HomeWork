...
<body>
    <img src="../../img/Untitled.png" alt="Logo">
        <div class="alert">
            <h2>Sąskaita buvo sėkmingai sukurta.</h2>
            <a href="http://localhost/homeWork/bankas2/public/bank-acc-panel/" class="myButton left" <?php $_SESSION['wrongLogin'] = '';?>>Grįžti</a>
            <br>
            <br>
        </div>
</body>
